...
/**
 * <p>
 * This is the abstract base class for all the expression objects that the compiler builds using the ANTLR4 AST nodes.
 * </p>
 *
 * @version 2.0
 */
public abstract class Exp extends ResolveConceptualElement {
    ...
    /**
     * <p>
     * This method overrides the default clone method implementation for all the classes that extend from {@link Exp}.
     * </p>
     *
    ...
    /**
     * <p>
     * Compares to see if the expression matches this object.
     * </p>
     *
     * @param exp
     *            A {@link Exp} to compare.
     *
     * @return A {@link VarExp} containing {@code true} if it is exactly the same, otherwise just return a deep copy our
     *         ourselves.
     */
    ...
    /**
     * <p>
     * This method must be implemented by all inherited classes to attempt to find the provided expression in our
     * sub-expressions.
     * </p>
     *
     * @param exp
     *            The expression we wish to locate.
     *
     * @return {@code true} if there is an instance of {@code exp} within this object's sub-expressions. {@code false}
     *         otherwise.
     */
    ...
    /**
     * <p>
     * This method attempts to find an expression with the given name in our sub-expressions. This method is only
     ...
     *            Expression name.
     * @param IsOldExp
     *            Flag to indicate if the given name is of the form {@code #[varName]}
     *
     * @return False.
     */
    ...
    public boolean equals(Object o) {
        ...
        /*
         * if (myLoc != null ? !myLoc.equals(exp.myLoc) : exp.myLoc != null) return false;
         */

        if (myLocationDetailModel != null ? !myLocationDetailModel.equals(exp.myLocationDetailModel)
                : exp.myLocationDetailModel != null)
            return false;
        if (myMathType != null ? !myMathType.equals(exp.myMathType) : exp.myMathType != null)
            return false;
        return myMathTypeValue != null ? myMathTypeValue.equals(exp.myMathTypeValue) : exp.myMathTypeValue == null;
    }

    /**
     * <p>
     * Shallow compare is too weak for many things, and equals() is too strict. This method returns {@code true}
     * <strong>iff</strong> this expression and the provided expression, {@code e}, are equivalent with respect to
     * structure and all function and variable names.
     * </p>
     *
     * @param e
     *            The expression to compare this one to.
     *
     * @return True <strong>iff</strong> this expression and the provided expression are equivalent with respect to
     *         structure and all function and variable names.
     */
    public boolean equivalent(Exp e) {
        System.out.println(e.toString());
        throw new UnsupportedOperationException(
                "Equivalence for classes of type " + this.getClass() + " is not currently supported.");
    }

    /**
     * <p>
     * Helper method to deal with {@link Exp}s that need to be compared but might be {@code null}. Returns {@code true}
     * <strong>iff</strong> {@code e1} and {@code e2} are both {@code null} or both are not {@code null} and equivalent.
     * </p>
     *
     * @param e1
     *            The first {@link Exp}.
     ...
     *            The second {@link Exp}.
     *
     * @return {@code true} <strong>iff</strong> both {@link Exp}s are {@code null}; or both are not {@code null} and
     *         are equivalent.
     */
    ...
    /**
     * <p>
     * This method gets the location details associated with this object.
     * </p>
     *
    ...
    /**
     * <p>
     * This method must be implemented by all inherited classes to return the list of sub-expressions.
     * </p>
     *
    ...
    @Override
    public int hashCode() {
        int result = myLocationDetailModel != null ? myLocationDetailModel.hashCode() : 0;
        result = 31 * result + (myMathType != null ? myMathType.hashCode() : 0);
        result = 31 * result + (myMathTypeValue != null ? myMathTypeValue.hashCode() : 0);
        return result;
    }

    /**
     * <p>
     * Helper method to deal with {@link PosSymbol}s that need to be compared but might be {@code null}. Returns
     * {@code true} <strong>iff</strong> {@code s1} and {@code s2} are both {@code null} or both are not {@code null}
     * and have names that are equivalent strings (see {@link Exp#stringEquivalent(String, String)})
     * </p>
     *
     * @param s1
     *            The first {@link PosSymbol}.
     * @param s2
     *            The second {@link PosSymbol}.
     *
     * @return {@code true} <strong>iff</strong> both {@link PosSymbol}s are {@code null}; or both are not {@code null}
     *         and have names that are equivalent strings (see {@link Exp#stringEquivalent(String, String)}).
     */
    ...
    /**
     * <p>
     * This method sets the location details associated with this object.
     * </p>
     *
     * @param locationDetailModel
     *            A {@link LocationDetailModel} object.
     */
    public final void setLocationDetailModel(LocationDetailModel locationDetailModel) {
    ...
    /**
     * <p>
     * Helper method to deal with strings that need to be compared but might be {@code null}. Returns {@code true}
     * <strong>iff</strong> {@code s1} and {@code s2} are both {@code null} or both are not {@code null} and represent
     * the same string (case sensitive).
     * </p>
     *
     * @param s1
     *            The first string.
     ...
     *            The second string.
     *
     * @return {@code true} <strong>iff</strong> both string are {@code null}; or both are not {@code null} and
     ...
     *            them.
     *
     * @return A new {@link Exp} that is a deep copy of the original with the provided substitutions made.
     */
    public final Exp substitute(Map<Exp, Exp> substitutions) {
        ...
        if (substitutions.size() > 0) {
            ...
            if (match) {
                ...
                if (myLocationDetailModel != null) {
                    retval.setLocationDetailModel(myLocationDetailModel.clone());
                }
            }
        } else {
            retval = this.clone();
    ...
    /**
     * <p>
     * A static helper method that calls substitute method using {@code e}.
     * </p>
     *
     * @param e
     *            The original {@link Exp}.
     * @param substitutions
     *            A mapping from {@link Exp}s that should be substituted out to the {@link Exp} that should replace
     *            them.
     *
    ...
    /**
     * <p>
     * Implemented by concrete subclasses of {@link Exp} to manufacture a copy of themselves where all sub-expressions
