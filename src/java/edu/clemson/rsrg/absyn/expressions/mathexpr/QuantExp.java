...
/**
 * <p>
 * This is the class for all the mathematical quantified expression objects that the compiler builds using the ANTLR4
 * AST nodes.
 * </p>
 *
 * @version 2.0
...
public class QuantExp extends MathExp {
     ...
     * @param vars
     *            A list of {@link MathVarDec}s representing the expression's variables.
     * @param where
     *            A {@link Exp} representing the where clause.
     * @param body
     *            A {@link Exp} representing the body of the expression.
     */
    public QuantExp(Location l, SymbolTableEntry.Quantification quantifier, List<MathVarDec> vars, Exp where,
            Exp body) {
        super(l);
    ...
    public final String asString(int indentSize, int innerIndentInc) {
        ...
        sb.append(",\n");
        sb.append(myBodyExp.asString(indentSize + innerIndentInc, innerIndentInc));
    ...
    public final boolean equals(Object o) {
        ...
        if (!myVars.equals(quantExp.myVars))
            return false;
        if (myWhereExp != null ? !myWhereExp.equals(quantExp.myWhereExp) : quantExp.myWhereExp != null)
            return false;
        ...
        if (retval) {
            ...
            if (myVars != null && eAsQuantExp.myVars != null) {
                ...
                while (retval && thisVars.hasNext() && eVars.hasNext()) {
                    ...
                    retval &= cThisVar.getName().equals(cEVar.getName()) && cThisVar.getTy().equals(cEVar.getTy());
                }
    ...
    /**
     * <p>
     * This method returns all the variable expressions in this quantified expression.
     * </p>
     *
    ...
    protected final Exp copy() {
        ...
        return new QuantExp(cloneLocation(), myQuantification, myVars, newWhere, myBodyExp.clone());
    }
    ...
    protected final Exp substituteChildren(Map<Exp, Exp> substitutions) {
        ...
        return new QuantExp(cloneLocation(), myQuantification, copyVars(), newWhere,
    ...
    /**
     * <p>
     * This is a helper method that makes a copy of the list containing all the variables in the expression.
     * </p>
     *
