...
/**
 * <p>
 * This is the abstract base class for all the intermediate objects that the compiler builds using the ANTLR4 AST nodes.
 * </p>
 *
 * @version 2.0
 */
public abstract class ResolveConceptualElement implements BasicCapabilities, Cloneable {
    ...
    /**
     * <p>
     * This method must be implemented by all inherited classes to create a special indented text version of the
     * instantiated object.
     * </p>
     *
     * @param indentSize
    ...
    /**
     * <p>
     * This method must be implemented by all inherited classes to override the default clone method implementation.
     * </p>
     *
            ...
            if (!Modifier.isStatic(curField.getModifiers())) {
                ...
                try {
                    ...
                    // if so, add the elements to the list of children
                        ...
                        Class<?> listOf = (Class<?>) ((ParameterizedType) curField.getGenericType())
                        ...
                        if (fieldList != null && fieldList.size() > 0
                            ...
                            children.add(new VirtualListNode(myLoc, this, curField.getName(),
    ...
    /**
     * <p>
     * This method must be implemented by all inherited classes to override the default {@code hashCode} method
     * implementation.
     * </p>
     *
    ...
    /**
     * <p>
     * In most situations, this method simply calls the {@link Location#clone()} method. However, there are
     * {@link ResolveConceptualElement ResolveConceptualElements} that the compiler creates internally that does not
     * belong to a location in a {@link ResolveFile}. In this case, we simply return {@code null}.
     * </p>
     *
     * @return A deep copy of the {@link Location} object or {@code null} if the original {@link Location} object is
     *         {@code null}.
     */
     ...
     *
     * @param numSpaces
     *            The number of blank spaces desired.
     * @param buffer
     *            The string buffer we are currently building.
     */
