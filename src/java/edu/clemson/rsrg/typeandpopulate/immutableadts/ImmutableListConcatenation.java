...
import edu.clemson.rsrg.typeandpopulate.iterators.ChainingIterator;

import java.util.Iterator;

/**
 * <p>
 * This class implements an immutable list after concatenating two immutable lists.
 * </p>
 *
 * @param <E>
...
public class ImmutableListConcatenation<E> extends AbstractImmutableList<E> {
    ...
    /**
     * <p>
     * This creates a new immutable list after concatenating two immutable lists.
     * </p>
     *
     * @param firstList
     *            An immutable list.
     * @param secondList
     *            Another immutable list.
     */
    public ImmutableListConcatenation(ImmutableList<E> firstList, ImmutableList<E> secondList) {
    ...
    public ImmutableList<E> head(int length) {
        ...
        if (length <= myFirstListSize) {
            ...
            retval = new ImmutableListConcatenation<>(myFirstList, mySecondList.head(length - myFirstListSize));
        }
    ...
    public final ImmutableList<E> tail(int startIndex) {
        ...
        if (startIndex < myFirstListSize) {
            retval = new ImmutableListConcatenation<>(myFirstList.tail(startIndex), mySecondList);
        } else {
