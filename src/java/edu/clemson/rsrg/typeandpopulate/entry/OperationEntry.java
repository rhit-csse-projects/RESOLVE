...
import edu.clemson.rsrg.typeandpopulate.immutableadts.ArrayBackedImmutableList;
import edu.clemson.rsrg.typeandpopulate.immutableadts.ImmutableList;
import edu.clemson.rsrg.typeandpopulate.immutableadts.LazilyMappedImmutableList;
...
public class OperationEntry extends SymbolTableEntry {
     ...
     *            The program parameters associated with this entry.
     */
    public OperationEntry(String name, ResolveConceptualElement definingElement, ModuleIdentifier sourceModule,
            PTType returnType, List<ProgramParameterEntry> parameters) {
        this(name, definingElement, sourceModule, returnType, new ArrayBackedImmutableList<>(parameters));
    }
     ...
     */
    public OperationEntry(String name, ResolveConceptualElement definingElement, ModuleIdentifier sourceModule,
            PTType returnType, ImmutableList<ProgramParameterEntry> parameters) {
    ...
    public final AffectsClause getAffectsClause() {
        ...
        if (element instanceof OperationDec) {
            ...
            affectsClause = ((OperationProcedureDec) element).getWrappedOpDec().getAffectedVars();
        }
    ...
    public final AssertionClause getEnsuresClause() {
        ...
        if (element instanceof OperationDec) {
            ...
            ensuresClause = ((OperationProcedureDec) element).getWrappedOpDec().getEnsures().clone();
        }
    ...
    public final AssertionClause getRequiresClause() {
        ...
        if (element instanceof OperationDec) {
            ...
            requiresClause = ((OperationProcedureDec) element).getWrappedOpDec().getRequires().clone();
        }
    ...
    /**
     * <p>
     * This method returns the program type associated with this entry's return value.
     * </p>
     *
     * @return An immutable list containing {@link ProgramParameterEntry} objects.
     */
     ...
     */
    @Override
    public final OperationEntry instantiateGenerics(Map<String, PTType> genericInstantiations,
            FacilityEntry instantiatingFacility) {
        return new OperationEntry(getName(), getDefiningElement(), getSourceModuleIdentifier(),
    ...
    /**
     * <p>
     * This is a helper class that provides an instantiation mapping for {@link ProgramParameterEntry}s.
     * </p>
     */
    private static class InstantiationMapping implements Mapping<ProgramParameterEntry, ProgramParameterEntry> {
        ...
        /**
         * <p>
         * This constructs a mapping between the generic instantiations and a instantiating facility.
         * </p>
         *
         ...
         *
         * @param input
         *            A generic {@link ProgramParameterEntry}.
         *
         * @return The instantiated {@link ProgramParameterEntry}.
         */
        @Override
        public final ProgramParameterEntry map(ProgramParameterEntry input) {
            return input.instantiateGenerics(myGenericInstantiations, myInstantiatingFacility);
        }
